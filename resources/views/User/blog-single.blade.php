      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-8 ftco-animate order-md-last">
            ...
            <p>
              <img src="user/images/image_7.jpg" alt="" class="img-fluid">
            </p>
            ...
            <p>
              <img src="user/images/image_8.jpg" alt="" class="img-fluid">
            </p>
            ...
            <div class="about-author d-flex p-4 bg-light">
              <div class="bio align-self-md-center mr-4">
                <img src="user/images/person_1.jpg" alt="Image placeholder" class="img-fluid mb-4">
              </div>
            ...
            <div class="pt-5 mt-5">
              ...
              <ul class="comment-list">
                <li class="comment">
                  <div class="vcard bio">
                    <img src="user/images/person_1.jpg" alt="Image placeholder">
                  </div>
